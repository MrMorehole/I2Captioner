...
Search for **I2Captioner** in the ComfyUI Manager custom node list and click Install.

### Manual
```bash
cd /path/to/ComfyUI/custom_nodes
git clone https://github.com/YOUR_USERNAME/I2Captioner
...
## Recommended companion node packs

These are used in the included workflow:

- [rgthree-comfy](https://github.com/rgthree/rgthree-comfy) — Fast Groups Bypasser, Lora Loader Stack
- [ComfyUI-Custom-Scripts](https://github.com/pythongosssss/ComfyUI-Custom-Scripts) — Show Text node
